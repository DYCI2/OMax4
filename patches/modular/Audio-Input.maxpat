{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 348.0, 110.0, 594.0, 754.0 ],
		"bgcolor" : [ 0.619608, 1.0, 0.929412, 1.0 ],
		"bglocked" : 1,
		"defrect" : [ 348.0, 110.0, 594.0, 754.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"fontsize" : 12.0,
					"patching_rect" : [ 312.0, 233.0, 62.0, 20.0 ],
					"numoutlets" : 1,
					"patcher" : 					{
						"fileversion" : 1,
...
, 							{
								"box" : 								{
									"maxclass" : "message",
									"text" : "window size 0 $1 78 $2, window exec",
									"outlettype" : [ "" ],
									"id" : "obj-77",
									"fontname" : "Arial",
									"numinlets" : 2,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"fontsize" : 12.0,
					"patching_rect" : [ 327.0, 261.0, 92.0, 18.0 ],
					"numoutlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"hidden" : 1,
					"patching_rect" : [ 312.0, 309.0, 34.0, 20.0 ],
					"numoutlets" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"fontsize" : 12.0,
					"patching_rect" : [ 312.0, 206.0, 79.0, 20.0 ],
					"numoutlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"fontsize" : 12.0,
					"patching_rect" : [ 312.0, 286.0, 69.0, 20.0 ],
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					...
					"triscale" : 0.5,
					"minimum" : 1,
					"presentation_rect" : [ 49.181885, 105.022949, 21.330078, 18.0 ],
					"maximum" : 28,
					"numinlets" : 1,
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"triscale" : 0.5,
					"minimum" : 1,
					"presentation_rect" : [ 25.181885, 105.022949, 21.330078, 18.0 ],
					"maximum" : 28,
					"numinlets" : 1,
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"triscale" : 0.5,
					"minimum" : 1,
					"presentation_rect" : [ 33.545441, 35.181824, 21.330078, 18.0 ],
					"numinlets" : 1,
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"triscale" : 0.5,
					"minimum" : 1,
					"presentation_rect" : [ 9.545441, 35.181824, 21.330078, 18.0 ],
					"numinlets" : 1,
					"fontsize" : 10.0,
