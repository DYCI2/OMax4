...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 201.0, 833.0, 32.5, 20.0 ],
					"text" : "- 2"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 470.5, 201.0, 32.5, 20.0 ],
					"text" : "b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 902.0, 247.0, 50.0, 18.0 ],
					"text" : "#1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "", "", "", "", "" ],
					"patching_rect" : [ 538.0, 20.0, 117.0, 19.0 ],
					"text" : "regexp [\\\\D]+([\\\\d]+)$"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 733.0, 75.0, 61.0, 18.0 ],
					"text" : "1. 1. 1. 1."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 470.5, 236.0, 81.0, 20.0 ],
					"text" : "s #0-bangout"
				}
...
,
						...
						"digest" : "",
						"tags" : "",
						"globalpatchername" : "#1Player1[4][3][3][4][4][4][1][1][4][6][1][1][1][1][1][1][1][1][1][2][4][1][2][2][2][2][2][3][3][3][3][3][2][2][3]",
						"boxes" : [ 							{
								"box" : 								{
									"comment" : "",
									"id" : "obj-8",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 828.0, 377.0, 143.0, 33.0 ],
					"saved_object_attributes" : 					{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 691.0, 98.0, 67.0, 18.0 ],
					"text" : "1. 0.7 1. 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 648.0, 75.0, 74.0, 18.0 ],
					"text" : "0.7 0.7 1. 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 606.0, 99.0, 74.0, 18.0 ],
					"text" : "0.7 1. 0.7 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 563.0, 75.0, 74.0, 18.0 ],
					"text" : "1. 0.7 0.7 1."
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 563.0, 48.0, 189.0, 20.0 ],
					"text" : "sel 1 2 3 4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 636.0, 283.0, 32.5, 13.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 43.350315, 90.360283, 24.0, 13.0 ],
					"text" : "1.01"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 584.0, 283.0, 28.5, 13.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 4.542173, 90.360283, 24.0, 13.0 ],
					"text" : "0.99"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 616.0, 283.0, 18.5, 13.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 28.350317, 90.360283, 15.0, 13.0 ],
					"text" : "1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "bang" ],
					"patching_rect" : [ 532.0, 143.0, 54.0, 20.0 ],
					"text" : "togedge"
				}
