{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 6.0, 49.0, 890.0, 570.0 ],
		"bglocked" : 0,
		"defrect" : [ 6.0, 49.0, 890.0, 570.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"text" : "print",
					"outlettype" : [ "" ],
					"patching_rect" : [ 767.0, 1567.0, 34.0, 18.0 ],
					"id" : "obj-171",
					"fontname" : "Arial",
					"numinlets" : 2,
					"numoutlets" : 1,
					"fontsize" : 12.0,
					"presentation_rect" : [ 767.0, 1567.0, 0.0, 0.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"text" : "zl slice 2",
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 605.0, 1476.0, 57.0, 20.0 ],
					"id" : "obj-170",
					"fontname" : "Arial",
					"numinlets" : 2,
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					...
					"text" : "midiformat",
					"outlettype" : [ "int" ],
					"patching_rect" : [ 603.0, 1511.0, 100.0, 20.0 ],
					"id" : "obj-45",
					"fontname" : "Arial",
					"numinlets" : 7,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "Write MidiFile",
					"patching_rect" : [ 591.0, 1313.0, 79.0, 18.0 ],
					"presentation" : 1,
					"id" : "obj-169",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 0,
					"fontsize" : 10.0,
					"presentation_rect" : [ 503.0, 552.0, 79.0, 18.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"text" : "t i b",
					"outlettype" : [ "int", "bang" ],
					"patching_rect" : [ 608.0, 1379.0, 32.5, 20.0 ],
					"id" : "obj-168",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					...
					"text" : "stop",
					"outlettype" : [ "" ],
					"patching_rect" : [ 768.0, 1501.0, 33.0, 18.0 ],
					"id" : "obj-167",
					"fontname" : "Arial",
					"numinlets" : 2,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 728.0, 1474.0, 34.0, 20.0 ],
					"id" : "obj-165",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					...
					"text" : "sel 0",
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 728.0, 1448.0, 36.0, 20.0 ],
					"id" : "obj-158",
					"fontname" : "Arial",
					"numinlets" : 2,
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					...
					"text" : "write",
					"outlettype" : [ "" ],
					"patching_rect" : [ 727.0, 1498.0, 36.0, 18.0 ],
					"id" : "obj-156",
					"fontname" : "Arial",
					"numinlets" : 2,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"text" : "record",
					"outlettype" : [ "" ],
					"patching_rect" : [ 675.0, 1468.0, 45.0, 18.0 ],
					"id" : "obj-155",
					"fontname" : "Arial",
					"numinlets" : 2,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"text" : "gate",
					"outlettype" : [ "" ],
					"patching_rect" : [ 614.0, 1436.0, 34.0, 20.0 ],
					"id" : "obj-154",
					"fontname" : "Arial",
					"numinlets" : 2,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "toggle",
					"outlettype" : [ "int" ],
					"patching_rect" : [ 610.0, 1338.0, 20.0, 20.0 ],
					"presentation" : 1,
					"id" : "obj-153",
					"numinlets" : 1,
					"numoutlets" : 1,
					"presentation_rect" : [ 485.0, 551.0, 16.0, 16.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"text" : "seq",
					"outlettype" : [ "int", "bang" ],
					"patching_rect" : [ 677.0, 1532.0, 32.5, 20.0 ],
					"id" : "obj-134",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 2,
