{
	"patcher" : 	{
		...
		"boxes" : [ 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "r WoMaxVisu-query",
					"numoutlets" : 1,
					"fontsize" : 12.0,
					"outlettype" : [ "" ],
					"color" : [ 1.0, 0.0, 0.0, 1.0 ],
					"patching_rect" : [ 359.0, 506.0, 115.0, 20.0 ],
					"id" : "obj-37",
					"fontname" : "Arial",
					"numinlets" : 0
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 359.0, 582.0, 83.0, 20.0 ],
					"id" : "obj-104",
					"fontname" : "Arial",
					"numinlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"color" : [ 1.0, 0.0, 0.0, 1.0 ],
					"patching_rect" : [ 234.0, 559.0, 92.0, 20.0 ],
					"id" : "obj-83",
					"fontname" : "Arial",
					"numinlets" : 0
				}
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "\"System:/Users/blevy/Projets/OMax/Releases/WoMax v1.6c/\"",
					"linecount" : 2,
					"numoutlets" : 1,
					"fontsize" : 12.0,
					"outlettype" : [ "" ],
					"patching_rect" : [ 279.0, 727.0, 291.0, 32.0 ],
					"id" : "obj-60",
					"fontname" : "Arial",
					"numinlets" : 2
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"fontsize" : 12.0,
					"patching_rect" : [ 287.0, 534.0, 43.0, 20.0 ],
					"id" : "obj-59",
					"fontname" : "Arial",
					"numinlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"outlettype" : [ "" ],
					"patching_rect" : [ 234.0, 585.0, 89.0, 18.0 ],
					"id" : "obj-44",
					"fontname" : "Arial",
					"numinlets" : 2
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"color" : [ 1.0, 0.0, 0.0, 1.0 ],
					"patching_rect" : [ 217.0, 609.0, 117.0, 20.0 ],
					"id" : "obj-48",
					"fontname" : "Arial",
					"numinlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"color" : [ 1.0, 0.0, 0.0, 1.0 ],
					"patching_rect" : [ 346.0, 651.0, 115.0, 20.0 ],
					"id" : "obj-40",
					"fontname" : "Arial",
					"numinlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 217.0, 471.0, 33.0, 20.0 ],
					"id" : "obj-36",
					"fontname" : "Arial",
					"numinlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"color" : [ 1.0, 0.0, 0.0, 1.0 ],
					"patching_rect" : [ 423.0, 607.0, 126.0, 20.0 ],
					"id" : "obj-35",
					"fontname" : "Arial",
					"numinlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 359.0, 556.0, 61.0, 20.0 ],
					"id" : "obj-32",
					"fontname" : "Arial",
					"numinlets" : 1,
					"saved_object_attributes" : 					{
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"outlettype" : [ "" ],
					"patching_rect" : [ 231.0, 508.0, 121.0, 18.0 ],
					"id" : "obj-30",
					"fontname" : "Arial",
					"numinlets" : 2
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"outlettype" : [ "" ],
					"patching_rect" : [ 231.0, 534.0, 53.0, 20.0 ],
					"id" : "obj-28",
					"fontname" : "Arial",
					"numinlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"outlettype" : [ "" ],
					"patching_rect" : [ 359.0, 531.0, 41.0, 18.0 ],
					"id" : "obj-33",
					"fontname" : "Arial",
					"numinlets" : 2
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 241.5, 392.0, 355.5, 392.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-40", 0 ],
					"hidden" : 0,
					"midpoints" : [ 588.0, 251.0, 601.0, 251.0, 601.0, 359.0, 554.0, 359.0, 554.0, 642.0, 355.5, 642.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-48", 0 ],
					"hidden" : 0,
					"midpoints" : [ 226.5, 495.5, 226.5, 495.5 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 226.5, 495.0, 313.5, 495.0 ]
				}
