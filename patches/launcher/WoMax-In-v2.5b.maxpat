...
, 			{
				"box" : 				{
					"maxclass" : "umenu",
					"items" : [ "(Current)", ",", "Default", ",", "SaxT/ClarBb", ",", "ClarBasse", ",", "Voice", ",", "Percussion", ",", "Sound_poetry", ",", "Guitar", ",", "Basse", ",", "Fagott", ",", "Michel Doneda", ",", "Beñat Achiary", ",", "Médéric Collignon", ",", "Brice Martin", ",", "Mari Kimura", ",", "MIDI" ],
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"varname" : "Presets",
					"text" : "pattrstorage Presets @autorestore 1 @savemode 2",
					...
					"fontsize" : 10.0,
					"numinlets" : 1,
					"autorestore" : "WoMax-In-Presets.All.json",
					"saved_object_attributes" : 					{
						"client_rect" : [ 4, 44, 625, 481 ],
						"parameter_enable" : 0,
						"paraminitmode" : 0,
						"storage_rect" : [ 365, 44, 1166, 630 ]
					}
