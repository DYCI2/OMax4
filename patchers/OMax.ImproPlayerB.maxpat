...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 201.0, 833.0, 32.5, 22.0 ],
					"style" : "",
					"text" : "- 2"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 470.5, 201.0, 32.5, 22.0 ],
					"style" : "",
					"text" : "b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 902.0, 247.0, 50.0, 22.0 ],
					"style" : "",
					"text" : "#1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 979.0, 299.0, 25.0, 25.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 915.0, 635.0, 65.0, 22.0 ],
					"style" : "",
					"text" : "closebang"
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 5,
									"outlettype" : [ "", "", "", "", "" ],
									"patching_rect" : [ 33.0, 118.0, 195.0, 19.0 ],
									"style" : "",
									"text" : "regexp [\\\\D]+([\\\\d]+)|[\\\\D]+\\\\[([\\\\d]+)\\\\]"
								}
...
,
					"patching_rect" : [ 859.0, 635.0, 50.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 909.0, 572.0, 33.0, 22.0 ],
					"style" : "",
					"text" : "t b s"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 909.0, 548.0, 66.0, 22.0 ],
					"style" : "",
					"text" : "r #0-Impro"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 859.0, 608.0, 146.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 878.0, 492.0, 74.0, 22.0 ],
					"style" : "",
					"text" : "prepend set"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 859.0, 467.0, 92.0, 22.0 ],
					"saved_object_attributes" : 					{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 874.0, 727.0, 28.0, 22.0 ],
					"style" : "",
					"text" : "t -1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 874.0, 702.0, 36.0, 22.0 ],
					"style" : "",
					"text" : "sel 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 874.0, 678.0, 73.0, 22.0 ],
					"style" : "",
					"text" : "r #0-Enable"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 908.0, 733.0, 90.0, 22.0 ],
					"style" : "",
					"text" : "r #0-SVP-Sync"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "", "", "", "", "" ],
					"patching_rect" : [ 538.0, 20.0, 117.0, 21.0 ],
					"style" : "",
					"text" : "regexp [\\\\D]+([\\\\d]+)$"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 341.0, 798.0, 66.0, 22.0 ],
					"style" : "",
					"text" : "r #0-Impro"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 270.81955, 94.477921, 81.0, 22.0 ],
					"style" : "",
					"text" : "s #0-bangout"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 394.0, 92.0, 68.0, 22.0 ],
					"style" : "",
					"text" : "s #0-Impro"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 27.0, 998.0, 66.0, 22.0 ],
					"style" : "",
					"text" : "r #0-Impro"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 4.0, 112.0, 25.0, 20.0 ],
					"style" : "",
					"triscale" : 0.5,
					"varname" : "Xfade"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 307.0, 251.0, 79.0, 22.0 ],
					"style" : "",
					"text" : "r #0-DelData"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 275.0, 348.0, 97.0, 22.0 ],
					"style" : "",
					"text" : "OMax.render #1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 92.0, 150.0, 92.0, 22.0 ],
					"style" : "",
					"text" : "s #0-SVP-Sync"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 360.0, 20.0, 79.0, 22.0 ],
					"style" : "",
					"text" : "loadmess #1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 872.0, 134.0, 74.0, 22.0 ],
					"style" : "",
					"text" : "prepend set"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 814.0, 244.0, 74.0, 22.0 ],
					"style" : "",
					"text" : "prepend set"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 746.0, 162.0, 74.0, 22.0 ],
					"style" : "",
					"text" : "prepend set"
				}
...
,
					"patching_rect" : [ 746.0, 131.0, 59.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 733.0, 75.0, 61.0, 22.0 ],
					"style" : "",
					"text" : "1. 1. 1. 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 740.0, 875.0, 50.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 741.0, 898.0, 143.0, 47.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 216.0, 939.0, 73.0, 22.0 ],
					"style" : "",
					"text" : "r #0-Enable"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 256.0, 145.0, 75.0, 22.0 ],
					"style" : "",
					"text" : "s #0-Enable"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 201.0, 874.0, 79.0, 22.0 ],
					"style" : "",
					"text" : "r #0-bangout"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 470.5, 236.0, 81.0, 22.0 ],
					"style" : "",
					"text" : "s #0-bangout"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "bang" ],
					"patching_rect" : [ 457.0, 168.0, 32.5, 22.0 ],
					"style" : "",
					"text" : "b"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 4.0, 153.0, 44.0, 20.0 ],
					"style" : "",
					"triscale" : 0.5,
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 4.0, 132.0, 26.0, 20.0 ],
					"style" : "",
					"triscale" : 0.5,
					"varname" : "Cut-Window"
				}
...
,
						...
						"style" : "",
						"subpatcher_template" : "",
						"globalpatchername" : "#1Player1[4][3][3][4][4][4][1][1][4][6][1][1][1][1][1][1][1][1][1][2][4][1][2][2][2][2][2][3][3][3][3][3][2][2][3][3]",
						"boxes" : [ 							{
								"box" : 								{
									"comment" : "",
									"id" : "obj-8",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 231.0, 959.0, 55.0, 22.0 ],
					"style" : "",
					"text" : "r #0-end"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 121.0, 92.0, 57.0, 22.0 ],
					"style" : "",
					"text" : "s #0-end"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 156.0, 42.0, 68.0, 22.0 ],
					"style" : "",
					"text" : "route bang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 828.0, 351.0, 91.0, 22.0 ],
					"style" : "",
					"text" : "storagewindow"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 828.0, 377.0, 143.0, 35.0 ],
					"saved_object_attributes" : 					{
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 42.67318, 39.843369, 12.868992, 12.868992 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 54.542171, 39.843369, 13.0, 13.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 356.0, 822.0, 79.0, 22.0 ],
					"style" : "",
					"text" : "loadmess #1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 70.0, 446.0, 79.0, 22.0 ],
					"style" : "",
					"text" : "loadmess #1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 252.0, 50.0, 68.0, 22.0 ],
					"style" : "",
					"text" : "route bang"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 327.0, 50.0, 59.5, 22.0 ],
					"style" : "",
					"text" : "t b 0 s 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 606.0, 151.0, 97.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 648.0, 75.0, 74.0, 22.0 ],
					"style" : "",
					"text" : "0.7 0.7 1. 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 606.0, 99.0, 74.0, 22.0 ],
					"style" : "",
					"text" : "0.7 1. 0.7 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 563.0, 75.0, 74.0, 22.0 ],
					"style" : "",
					"text" : "1. 0.7 0.7 1."
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 563.0, 48.0, 189.0, 22.0 ],
					"style" : "",
					"text" : "sel 1 2 3 4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "bang", "", "list", "list", "int" ],
					"patching_rect" : [ 381.0, 293.0, 97.0, 22.0 ],
					"style" : "",
					"text" : "OMax.render #1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 516.0, 859.0, 51.0, 22.0 ],
					"style" : "",
					"text" : "target 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"patching_rect" : [ 618.0, 982.0, 84.0, 22.0 ],
					"style" : "",
					"text" : "buffer~ empty"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "" ],
					"patching_rect" : [ 443.0, 941.0, 250.0, 22.0 ],
					"style" : "",
					"text" : "poly~ OMax.ImproOut-Play 8 @args 20"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 50.438534, 71.360283, 15.186308, 15.186308 ],
					"style" : "",
					"varname" : "Direction"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 45.350315, 90.360283, 22.0, 16.0 ],
					"style" : "",
					"text" : "1.01"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 4.542173, 90.360283, 22.0, 16.0 ],
					"style" : "",
					"text" : "0.99"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 29.350317, 90.360283, 14.0, 16.0 ],
					"style" : "",
					"text" : "1."
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 5.542173, 37.843369, 38.0, 19.0 ],
					"style" : "",
					"triangle" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "bang" ],
					"patching_rect" : [ 532.0, 143.0, 54.0, 22.0 ],
					"style" : "",
					"text" : "togedge"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 5.542173, 69.360283, 42.0, 20.0 ],
					"style" : "",
					"varname" : "Speed"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 4.385544, 4.999908, 13.350493, 13.350493 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 2.819294, 3.420021, 17.044186, 17.044186 ],
					"prototypename" : "blue",
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 902.0, 220.0, 114.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 2.0, 2.0, 69.0, 105.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 214.5, 137.5, 541.5, 137.5 ],
					"source" : [ "obj-107", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 363.5, 127.0, 942.5, 127.0 ],
					"source" : [ "obj-127", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 576.5, 583.0, 488.5, 583.0 ],
					"source" : [ "obj-38", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 576.5, 766.0, 510.5, 766.0 ],
					"source" : [ "obj-38", 1 ]
				}
...
, 			{
				...
				"bootpath" : "~/Music/OFondue/OMax 4.5.3_/OMax Patches&Objects",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
