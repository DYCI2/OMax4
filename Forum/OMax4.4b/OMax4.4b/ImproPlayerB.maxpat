{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ -9.0, -994.0, 1003.0, 826.0 ],
		"bgcolor" : [ 0.623529, 0.929412, 1.0, 1.0 ],
		"bglocked" : 0,
		"defrect" : [ -9.0, -994.0, 1003.0, 826.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"text" : "s #0-bangout",
					"numinlets" : 1,
					"patching_rect" : [ 106.0, 604.0, 81.0, 20.0 ],
					"id" : "obj-170",
					"fontname" : "Arial",
					"numoutlets" : 0,
					"fontsize" : 12.0
...
, 			{
				"box" : 				{
					...
					"text" : "t b b b",
					"numinlets" : 1,
					"patching_rect" : [ 92.0, 577.0, 46.0, 20.0 ],
					"id" : "obj-185",
					"fontname" : "Arial",
					"numoutlets" : 3,
...
, 			{
				"box" : 				{
					...
					"text" : "+ 1",
					"numinlets" : 2,
					"patching_rect" : [ 92.0, 528.0, 32.5, 20.0 ],
					"id" : "obj-192",
					"fontname" : "Arial",
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
...
, 			{
				"box" : 				{
					...
					"text" : ">= 1",
					"numinlets" : 2,
					"patching_rect" : [ 92.0, 501.0, 35.0, 20.0 ],
					"id" : "obj-193",
					"fontname" : "Arial",
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"patching_rect" : [ 92.0, 553.0, 54.0, 20.0 ],
					"id" : "obj-194",
					"fontname" : "Arial",
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
...
, 			{
				"box" : 				{
					...
					"patcher" : 					{
						...
						"enablevscroll" : 1,
						"devicewidth" : 0.0,
						"globalpatchername" : "#1Player1[4][3][3][4][4][4][1][1][4][6][1][1][1][1][1][1][1][1][1][2][4][1][3][3]",
						"boxes" : [ 							{
								"box" : 								{
									"maxclass" : "inlet",
									"numinlets" : 0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"patching_rect" : [ 74.0, 445.0, 110.0, 20.0 ],
					"id" : "obj-131",
					"fontname" : "Arial",
					"numoutlets" : 1,
					"outlettype" : [ "" ],
...
, 			{
				"box" : 				{
					...
					"color" : [ 0.8, 0.403922, 1.0, 1.0 ],
					"numinlets" : 1,
					"patching_rect" : [ 74.0, 471.0, 49.0, 20.0 ],
					"id" : "obj-134",
					"fontname" : "Arial",
					"numoutlets" : 1,
					"outlettype" : [ "" ],
...
, 			{
				"box" : 				{
					...
					"text" : "i 0",
					"numinlets" : 2,
					"patching_rect" : [ 46.0, 697.0, 32.5, 20.0 ],
					"id" : "obj-77",
					"fontname" : "Arial",
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
...
, 			{
				"box" : 				{
					...
					"text" : "- 1",
					"numinlets" : 2,
					"patching_rect" : [ 74.0, 639.0, 32.5, 20.0 ],
					"id" : "obj-66",
					"fontname" : "Arial",
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
...
, 			{
				"box" : 				{
					...
					"text" : "maximum 0",
					"numinlets" : 2,
					"patching_rect" : [ 74.0, 667.0, 73.0, 20.0 ],
					"id" : "obj-72",
					"fontname" : "Arial",
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
...
, 			{
				"box" : 				{
					...
					"color" : [ 0.0, 0.0, 1.0, 1.0 ],
					"numinlets" : 1,
					"patching_rect" : [ 157.0, 404.0, 24.0, 20.0 ],
					"id" : "obj-87",
					"fontname" : "Arial",
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"color" : [ 0.0, 0.0, 1.0, 1.0 ],
					"midpoints" : [ 538.5, 191.5, 136.5, 191.5 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-2", 1 ],
					"hidden" : 0,
					"midpoints" : [ 83.5, 630.0, 117.0, 630.0, 117.0, 765.0, 117.0, 765.0, 117.0, 891.0, 174.0, 891.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"color" : [ 0.0, 0.0, 1.0, 1.0 ],
					"midpoints" : [ 370.5, 735.0, 189.0, 735.0, 189.0, 397.0, 166.5, 397.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"color" : [ 0.0, 0.0, 1.0, 1.0 ],
					"midpoints" : [ 166.5, 429.0, 195.0, 429.0, 195.0, 75.0, 214.5, 75.0 ]
				}
