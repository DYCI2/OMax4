{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 165.0, 48.0, 1003.0, 826.0 ],
		"bgcolor" : [ 0.623529, 0.929412, 1.0, 1.0 ],
		"bglocked" : 0,
		"defrect" : [ 165.0, 48.0, 1003.0, 826.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"patching_rect" : [ 574.919739, 867.315796, 44.0, 18.0 ],
					"presentation" : 1,
					"id" : "obj-181",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"patching_rect" : [ 519.919739, 869.719727, 33.0, 18.0 ],
					"presentation" : 1,
					"id" : "obj-182",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"patching_rect" : [ 701.0, 491.0, 44.0, 18.0 ],
					"presentation" : 1,
					"id" : "obj-183",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"fontsize" : 12.0,
					"presentation_rect" : [ 71.469795, 36.786591, 52.0, 20.0 ],
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"fontsize" : 12.0,
					"presentation_rect" : [ 15.301016, 0.530111, 59.0, 20.0 ],
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"fontsize" : 12.0,
					"presentation_rect" : [ 71.469795, 124.0, 60.0, 20.0 ],
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"fontsize" : 12.0,
					"presentation_rect" : [ 1.263134, 18.093964, 75.53949, 20.0 ],
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"numoutlets" : 0,
					"patching_rect" : [ 753.0, 540.0, 69.0, 20.0 ],
					"id" : "obj-170",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 281.0, 264.0, 67.0, 20.0 ],
					"id" : "obj-23",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 273.0, 317.0, 32.5, 20.0 ],
					"id" : "obj-53",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 273.0, 292.0, 37.0, 20.0 ],
					"id" : "obj-61",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 273.0, 343.0, 97.0, 20.0 ],
					"id" : "obj-164",
					"fontname" : "Arial",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 864.0, 568.0, 90.0, 20.0 ],
					"id" : "obj-166",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 864.0, 598.0, 25.0, 25.0 ],
					"id" : "obj-168",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 361.0, 28.0, 79.0, 20.0 ],
					"id" : "obj-165",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"patcher" : 					{
						...
						"enablevscroll" : 1,
						"devicewidth" : 0.0,
						"globalpatchername" : "#1Player1[4][3][3][4][4][4][1][1][4][6][1][1][1]",
						"boxes" : [ 							{
								"box" : 								{
									"maxclass" : "inlet",
									"numinlets" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 828.0, 377.0, 142.0, 34.0 ],
					"id" : "obj-221",
					"fontname" : "Arial",
					"saved_object_attributes" : 					{
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"numoutlets" : 0,
					"patching_rect" : [ 323.0, 375.0, 74.0, 20.0 ],
					"id" : "obj-68",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 697.0, 515.0, 67.0, 20.0 ],
					"id" : "obj-37",
					"fontname" : "Arial",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 293.0, 375.0, 25.0, 25.0 ],
					"id" : "obj-35",
					"comment" : "Data Out"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"fontsize" : 12.0,
					"presentation_rect" : [ 71.469795, 53.843369, 58.0, 20.0 ],
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 732.0, 490.0, 79.0, 20.0 ],
					"id" : "obj-54",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 4.385543, 3.999908, 13.350493, 13.350493 ],
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 2.819294, 2.420021, 17.044186, 17.044186 ],
					"numoutlets" : 1,
